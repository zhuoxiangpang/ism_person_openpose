...
class Train:
    def __init__(self, root):
        ...
        self.net.load_state_dict(
            torch.load("D:/project/ism_person_openpose/action_detect/checkPoint/action.pt", map_location='cpu'))
    ...
    def __call__(self):
        for epoch in range(100000):
            ...
            torch.save(self.net.state_dict(), f"./checkPoint/train/action.jit")  # 保存训练的数据


if __name__ == '__main__':
    train = Train('D:/project/ism_person_openpose/data')
    train()
